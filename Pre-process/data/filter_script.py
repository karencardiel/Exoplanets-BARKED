...
# Load the dataset, skipping the commented lines at the beginning
df = pd.read_csv('raw_sample.csv', comment='#')
...
print("Filtered CSV file 'filtered_sample.csv' created successfully.")
